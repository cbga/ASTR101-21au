...
\begin{document}
    ...
    \subsection*{Galaxy}
    \begin{itemize}
        \item Disk: flattened, thin stretch of stars.
        \item Bulge: Elliptical shaped, lots of concentrated stars.
        \item Halo: Large region outside if disk encompassing the entire Galaxy.
    \end{itemize}
    \subsubsection*{Interstellar Medium (ISM)}
    Only \emph{disk} and \emph{bulge} we see lots of gass, dust and other bits of matter between stars, 
    which is called intersteller medium. No stars formation in Halol.
